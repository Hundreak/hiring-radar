  ...
  return (
    <MarketingPageShell locale={locale}>
      <section className="container-shell py-20">
        <SectionHeading
          eyebrow="Hakkımızda"
          title="CoreSift, kariyer kararlarını daha net ve daha sistematik hale getirmek için inşa edildi."
          description="Biz bir ilan listesi sunmaktan daha fazlasını hedefliyoruz. CoreSift; adayların kendilerini daha doğru ifade edebildiği, iş piyasasını daha anlamlı okuyabildiği ve daha güçlü fırsatlara daha bilinçli şekilde ilerleyebildiği bir kariyer altyapısıdır."
        />
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          <div className="rounded-[28px] border border-white/10 bg-[#171717] p-8">
            ...
            <p className="mt-5 text-base leading-8 text-white/68">
              CoreSift; aday profillerini yapılandıran, CV içeriğini anlamlandıran,
          ...
          <div className="rounded-[28px] border border-white/10 bg-[#171717] p-8">
            ...
            <p className="mt-5 text-base leading-8 text-white/68">
              CoreSift bu sorunu çözmek için var. Kariyer ekosistemini; veri kalitesi,
        ...
        <div className="mt-6 rounded-[32px] border border-white/10 bg-[#151515] p-8 md:p-10">
          ...
          <p className="mt-6 max-w-4xl text-lg leading-8 text-white/68">
            CoreSift’i, adayların kendilerini daha iyi tanıdığı, profillerini daha güçlü
