    ...
    try:
        ...
        repo.upsert_job_external_context_snapshot(
            JobExternalContextSnapshot(
                ...
                meta_description='Platform role with Terraform, AWS, and Kubernetes ownership.',
                clean_text='Requirements: Terraform, AWS, Kubernetes, Prometheus, Grafana. Responsibilities: own reliability and drive architecture. What we offer: remote flexibility.',
                ...
                company_culture_clues=('Remote flexibility',),
                technology_stack_terms=('terraform', 'aws', 'kubernetes', 'prometheus', 'grafana'),
        ...
        assert 'prometheus' in feature.skill_terms
